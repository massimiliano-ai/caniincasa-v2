...
function caniincasa_scripts() {
    ...
    // Enqueue quiz CSS (on quiz page and single allevamenti for result cards)
    if ( is_page_template( 'page-templates/template-quiz-scelta-razza.php' ) || is_singular( 'allevamenti' ) ) {
        wp_enqueue_style(
            'caniincasa-quiz',
    ...
    // Enqueue quiz JS (only on quiz page)
        ...
        while ( $query->have_posts() ) {
            ...
            <div class="item-card">
                ...
                <div class="item-content">
                    ...
                    <?php
                    // Località e Provincia - using ACF fields (different per post type)
                    ...
                    <?php
                        ...
                        // For other post types, show only provincia
                        $provincia_display = '';
                    ...
                    // Don't show phone for canili in preview
                    $show_telefono = ( $post_type !== 'canili' ) && $telefono;

                    if ( $show_telefono || $email || $sito_web ):
                    ?>
                        <div class="item-contacts">
                            <?php if ( function_exists( 'caniincasa_can_view_contacts' ) && caniincasa_can_view_contacts() ): ?>
                                <?php if ( $show_telefono ): ?>
