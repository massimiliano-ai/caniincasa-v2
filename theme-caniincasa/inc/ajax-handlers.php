...
function caniincasa_ajax_filter_razze() {
    ...
    // Tolleranza per i filtri: ±1.5 punti
    $tolerance = 1.5;
    ...
    if ( $energy > 0 ) {
        $meta_query[] = array(
            ...
            'value'   => array( max( 0, $energy - $tolerance ), min( 5, $energy + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
    ...
    if ( $apartment > 0 ) {
        $meta_query[] = array(
            ...
            'value'   => array( max( 0, $apartment - $tolerance ), min( 5, $apartment + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
    ...
    if ( $affection > 0 ) {
        $meta_query[] = array(
            'key'     => 'affettuosita',
            'value'   => array( max( 0, $affection - $tolerance ), min( 5, $affection + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
    ...
    if ( $strangers > 0 ) {
        $meta_query[] = array(
            ...
            'value'   => array( max( 0, $strangers - $tolerance ), min( 5, $strangers + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
    ...
    if ( $vocality > 0 ) {
        $meta_query[] = array(
            ...
            'value'   => array( max( 0, $vocality - $tolerance ), min( 5, $vocality + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
    ...
    if ( $kids > 0 ) {
        $meta_query[] = array(
            ...
            'value'   => array( max( 0, $kids - $tolerance ), min( 5, $kids + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
    ...
    if ( $experience < 5 ) {
        $meta_query[] = array(
            ...
            'value'   => array( max( 0, $experience - $tolerance ), min( 5, $experience + $tolerance ) ),
            'compare' => 'BETWEEN',
            'type'    => 'NUMERIC',
        );
    }
