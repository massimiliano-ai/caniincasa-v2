...
<main id="main-content" class="site-main page-annunci">
    <div class="container">
        ...
        <header class="page-hero">
            <h1 class="page-title">
                <?php esc_html_e( 'Annunci Dogsitter', 'caniincasa' ); ?>
            </h1>
            <p class="page-intro">
        ...
        if ( have_posts() ) {
            ...
            update_post_caches( $wp_query->posts, 'annunci_dogsitter', true, true );
            update_object_term_cache( $post_ids, 'annunci_dogsitter' );
        }
        ?>
                    ...
                    <article class="annuncio-horizontal-card">
                        ...
                        <div class="annuncio-image-wrapper">
                            ...
                            <div class="annuncio-type-badge">
                                <span class="badge badge-dogsitter">🦴 Dogsitter</span>
                            </div>
                        </div>
                            ...
                            <div class="annuncio-additional-meta">
                                ...
                                ?>
                                    <span class="meta-item">
                                        ...
                                        <span class="text"><?php echo esc_html( $zona ); ?></span>
                                    </span>
                                <?php endif; ?>
                            </div>
